...
func (x *TrainRequest) GetConf() string {
	if x != nil {
		return x.Conf
	}
	return ""
...
func (x *TrainRequest) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
var file_edge_proto_rawDesc = []byte{
	...
	0x0c, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a,
	0x04, 0x63, 0x6f, 0x6e, 0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x6e,
	0x66, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x44,
	0x0a, 0x0b, 0x45, 0x64, 0x67, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x35, 0x0a,
	0x09, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x10, 0x2e, 0x70, 0x62, 0x2e,
...
var file_edge_proto_goTypes = []interface{}{
	(*TrainRequest)(nil),  // 0: pb.TrainRequest
	(*emptypb.Empty)(nil), // 1: google.protobuf.Empty
}
var file_edge_proto_depIdxs = []int32{
	0, // 0: pb.EdgeService.TrainTask:input_type -> pb.TrainRequest
	1, // 1: pb.EdgeService.TrainTask:output_type -> google.protobuf.Empty
